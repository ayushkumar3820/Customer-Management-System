...
const CustomerForm = ({ onSubmit, initialData = {}, onCancel }) => {
    ...
    const defaultMemberships = [
        { _id: 'default-basic', name: 'Basic Membership' },
        { _id: 'default-standard', name: 'Standard Membership' },
        { _id: 'default-premium', name: 'Premium Membership' }
    ];
    ...
    const loadMemberships = async () => {
        try {
            ...
            if (data && data.length > 0) {
                ...
                console.info('No memberships returned from API, using default options');
            }
        } catch (error) {
    ...
    return (
        <form onSubmit={handleSubmit} className="space-y-6 max-w-2xl mx-auto p-6 bg-gray-100 rounded-xl shadow-md">
            ...
            <div className="grid grid-cols-2 gap-6">
                <div>
                    ...
                    >
                        <option value="Gold" style={{ color: 'black', backgroundColor: 'white' }}>Gold</option>
                        <option value="Diamond" style={{ color: 'black', backgroundColor: 'white' }}>Diamond</option>
                    </select>
                </div>
                    ...
                    {loading ? (
                        ...
                        <>
                            <select
                                ...
                                style={{ color: 'black', backgroundColor: 'white' }}
                            >
                                <option value="" style={{ color: 'black', backgroundColor: 'white' }}>Select Membership</option>
